...
//*global_out_stream_ptr << "Checkpoint #2" << endl;
			avgCrosstermCFvals[ipt][ipphi][iqx][iqy][iqz] += tmp_spectra*tmp_spectra*tmp_crossterm;
//*global_out_stream_ptr << "Checkpoint #3" << endl;
			avgResonancesCFvals[ipt][ipphi][iqx][iqy][iqz] += tmp_spectra*tmp_spectra*tmp_resonance;
